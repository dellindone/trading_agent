...
class BtcEngine:
    ...
    def _poll(self):
        ...
        htf_trend    = int(last.get("15m_smc_trend", 0) or 0)
        ...
        if signal is not None:
            ...
            if htf_block:
                ...
                outcome = f"skip: HTF_BLOCK (15m_smc_trend={htf_str} opposes {closer} 1m setup)"
            else:
        ...
        self._last_eval_summary = (
            ...
            f"atr_15m={atr_15m:.0f} htf_trend={htf_trend:+d} "
